...
```{r saratoga_linear, include = FALSE}
# My linear model
...
According to the table, over 20 folds of the `hotels_val` set there is only a difference of `hotels_final[21,3]` between expected and actual number of bookings with children. With about 5,000 bookings in the 20 folds combined, this number is pretty low.
